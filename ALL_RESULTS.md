...
- **2026-09-16T07:56:06Z | corrected delivery check**
  ...
  - RESULT: EHR content comparison: inbox and analysed copies carry the same patient ids in every file: True
  - RESULT: corrected registry ids: 13806 distinct vs 13806 original; identical=True; shared 13806
  - RESULT: corrected registry: 0 of 13806 shared ids keep the same row content (0.0%) -- the rest were relabelled
...
### RUN 2026-09-16T07:56:06Z | corrected delivery check
...
=== 1b. EHR content: same data, or different data? ========================
  file                                inbox rows   cur rows  inbox ids   cur ids  ids equal
  consult_20251208.csv                   286,193    286,193      8,991     8,991       True
  dbc_20251203.csv                       187,827    187,827     12,532    12,532       True
  diag_20250626.csv                      127,741    127,741     14,354    14,354       True
  ecg_measmatrix_20251208.csv            154,214    154,214     15,390    15,390       True
  echo_20250626.csv                      671,168    671,168      4,768     4,768       True
  hos_20251209.csv                        43,553     43,553     12,227    12,227       True
  hos_mut_20251209.csv                   129,462    129,462     12,227    12,227       True
  lab_ezis_20250709.csv                3,322,765  3,322,765     11,298    11,298       True
  med_20250709.csv                       747,888    747,888     11,864    11,864       True
  meting_20251203.csv                 22,276,566 22,276,566     15,831    15,831       True
  mri_verslag_20250626.csv                 3,159      3,159      1,679     1,679       True
  ok_20250626.csv                         35,117     35,117      7,548     7,548       True
  ok_verslag_20250626.csv                 80,363     80,363      4,531     4,531       True
  radiologie_verslag_20251208.csv         78,722     78,722     10,893    10,893       True
  uitgaandebrief_20251208.csv             61,713     61,713      8,472     8,472       True
  verr_20251203.csv                       32,923     32,923      2,989     2,989       True
RESULT: EHR content comparison: inbox and analysed copies carry the same patient ids in every file: True
...
RESULT: corrected registry: 0 of 13806 shared ids keep the same row content (0.0%) -- the rest were relabelled
    -> most ids now point at a DIFFERENT row: this is a relabelling,
       which is exactly what a corrected linkage should look like
